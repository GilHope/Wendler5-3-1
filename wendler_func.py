...
def calculate_wendler_531(orms):
    ...
    rep_schemes = {
        "week1": [(5, 0.65), (5, 0.75), (5, 0.85)],
        "week2": [(3, 0.70), (3, 0.80), (3, 0.90)],
        "week3": [(5, 0.75), (3, 0.85), (1, 0.95)],
        "week4": [(5, 0.40), (5, 0.50), (5, 0.60)]
    }
    ...
    for week, reps_and_percs in rep_schemes.items():
        ...
        for lift, training_max in training_maxes.items():
            workout_plan[week][lift] = [(reps, round(training_max * perc / 5) * 5) for reps, perc in reps_and_percs]
